...
private:
    ...
    bool check_is_union_member(expr*, const colgm_union&);
    std::string get_union_label(expr*, const colgm_union&);
    void resolve_match_stmt_for_union(match_stmt*, const colgm_func&, const type&);
